...
public class EnregistrerReservation {
	...
	private void initialize() {
		...
		JLabel idreserv = new JLabel("23456");
		idreserv.setBounds(32, 307, 74, 14);
		frame.getContentPane().add(idreserv);
		
		JLabel prix = new JLabel("2345.2");
		prix.setBounds(32, 335, 74, 14);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String Select2="SELECT ClientID FROM `client` WHERE Nom="+textField.getText()+" AND Prenom="+textField_1.getText()+";";
				int clientId=0;
				try {
